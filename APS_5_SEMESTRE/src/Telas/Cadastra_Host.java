...
public class Cadastra_Host extends classesExec.MudaTema {
    ...
    private void initComponents() {
        ...
        jCheckBoxSouHost.setText("Preencher autom�tico");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Verifica se os IPs est�o corretos e conecta o servidor caso estejam
        if (isValidLogin()) {
    ...
    try {
     ...
     private boolean isValidLogin() {
        ...
        if (validIP(jTextFieldIpPublicoServidor.getText()) == false)
            builder.append("IP publico do servidor inválido.\n");

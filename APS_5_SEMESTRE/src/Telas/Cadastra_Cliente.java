...
public class Cadastra_Cliente extends classesExec.MudaTema {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("IP Publico do servidor:");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel4.setText("IP Local do servidor:");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jLabel5.setText("Seu IP Publico:");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Fotos/LogoChacara-1.png"))); // NOI18N
        ...
        jCheckBoxCliente.setText("Preencher automatico");
    ...
    private void jCheckBoxClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxClienteActionPerformed
        ...
        //Pega o valor do IP p�blico e local e preenche automaticamente os campos
        ...
        //Else habilita os campos para serem preenchidos pelo usu�rio
        }else{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Verifica se os IPs est�o corretos e conecta com o servidor caso estejam
        if (isValidLogin()) {
        InformacoesCliente infoCliente = new InformacoesCliente(0, jTextFieldIpPublicoCliente.getText(), jTextFieldIpLocalCliente.getText(), jTextFieldNome.getText());
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Servidor não encontrado, verifique se os dados estão corretos.", "Servidor n�o encontrado", JOptionPane.ERROR_MESSAGE);
                }
         }
...
//Pega o IP locar atrav�s do iNetAddress
...
//Confere se o IP inserido � um IP v�lido
    ...
    //Pega o IP p�blico atrv�s de sites
    private String getIPPublico() {
        ...
        for (int i = 0, l = urls.length; ip == null && i < l; i++) {
            try {
                ...
                JOptionPane.showMessageDialog(null, error.getCause().toString() + " - " + error.getMessage(), "Erro ao recuperar IP P�blico", JOptionPane.ERROR_MESSAGE);
            } catch (IOException error) {
                JOptionPane.showMessageDialog(null, error.getCause().toString() + " - " + error.getMessage(), "Erro ao recuperar IP P�blico", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    //Faz as verifica��es necess�rias para ver se os IPs inseridos s�o validos
    private boolean isValidLogin() {
        StringBuilder builder = new StringBuilder();
        if (jTextFieldIpPublicoServidor.getText() == null || jTextFieldIpPublicoServidor.getText().trim().isEmpty())
            builder.append("IP publico do servidor não pode ser vazio.\n");
        ...
        if (jTextFieldIpPublicoCliente.getText() == null || jTextFieldIpPublicoCliente.getText().trim().isEmpty())
            builder.append("IP publico do cliente não pode ser vazio.\n");
        ...
        if (validIP(jTextFieldIpPublicoCliente.getText()) == false)
            builder.append("IP publico do cliente é inválido.\n");
